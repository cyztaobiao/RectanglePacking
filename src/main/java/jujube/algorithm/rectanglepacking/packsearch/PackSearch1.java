package jujube.algorithm.rectanglepacking.packsearch;
...
public class PackSearch1 {
	final int MAX_NUM_OF_RECTANGLE = 256;
	int maxArea = 0;
	int numOfRec = 0;
	int minArea = 0;
	...
	public void init(Rectangle[] rects, int num) {
		recList = rects;
		numOfRec = num;
	...
	public PackSearch1(Rectangle[] rects, int num) {
		init(rects, num);
	}
	...
	public int[] getIncreasedArea(int crtH, int crtW, int h, int w,
		...
		if (upOrRight == 1) {
			...
			System.out.println("Error: please specify the place for adding the next rectangle.");
		}
	...
	public static void main(String args[]) {
		PackSearch1 ps = new PackSearch1("data" + File.separator + "test7.txt");
